...
> 所有 skill 均由 **Stanley Team** 成员贡献。

---

## 关于 Stanley Team

Stanley Team 是一支活跃于全球人工智能前沿、兼具国际视野与产业落地能力的高影响力 AI 社群组织。

**核心成员背景**

- **权威认证**：拥有 Anthropic、Google 等国际顶级大模型官方认证专家
- **顶尖履历**：汇聚前中科院、字节跳动、腾讯、阿里、美团等头部机构与大厂核心人才
- **实战深度**：覆盖 AI 算法、Agent 构建、企业安全、跨境电商、内容增长、法律合规与企业管理等一线领域

**影响力**

- 成员全网粉丝规模超 **百万**，累计内容曝光突破 **十亿级**
- 国内少数同时具备「技术深度、产业资源、传播影响力与企业交付能力」的复合型 AI 组织

**核心定位**

以「**AI 新质生产力研究、AI 技能培训、企业定制化交付**」三位一体为核心，连接全球顶级大模型生态与中国企业真实业务场景。团队长期深耕企业安全运营、跨境业务增长、内容营销发布、AI 工作流搭建、法律合规与私域增长等高价值场景，沉淀了大量可复制、可交付、可规模化的解决方案。

**使命**

帮助个人、团队与企业完成从「了解 AI」到「用 AI 创造增长」的关键跃迁，打造面向未来的 AI 实战型专家共同体。
